...
function Events() {
  ...
  //   const newresetLanguages = Evelanguage.map((x, i) => {

  //     return x
  //   })
  //   setEveLanguage(newresetLanguages)
  // }
  ...
  function multiplelangStates(index) {
    ...
    // newlanbtnActive = [true, false, false, false, false, false, false, false, false]
  ...
  function filterfunction() {
    // let lang = [];
    // const totalfilterArrays = Evelanguage.map((lang) => {
    //   if (lang) {
    // let totalfilterArrays = array1.filter((ele) => ele.languages == x);
    //   }
    // });
    // console.log(totalfilterArrays);
    // totalfilterArrays = totalfilterArrays[0].concat(totalfilterArrays[1]);
    // setnewEveLanguage(totalfilterArrays);/
  }
